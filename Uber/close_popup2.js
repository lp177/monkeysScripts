...
(function () {
    ...
    var max_retry = 50,
        ...
        max_wait_url_change = 100;
    const is_good_url = /https:\/\/www\.ubereats\.com\/.+?\/checkout.+/gm,
        max_wait_url_change_default = 100;
    function close() {
        const closeSugestion = document.querySelector(
            'div[role="dialog"] button[aria-label="Fermer"],div[role="dialog"] button[aria-label="Close"]',
        );
        if (closeSugestion) {
            max_retry = 50;
