...
// @description  Display notification on each delivery status changed for chronopost
// @author       lp177
// @namespace    lp177
...
(function() {
	...
	setTimeout(()=>scrollTo(0, 850), 1000);
    async function alertOnChange() {
        ...
        const lastText=document.querySelector('#tracking-container tbody tr td:nth-of-type(2)')?.innerText;
