...
(function() {
	...
	function update(max_retry = 100)
	{
		...
		if(title)
			title.innerHTML = "Read the best stories at: <a href='https://freedium.cfd/" + location.href + "' style='font-weigth:bold;text-decoration:underline;'>freedium</a>";
		else if (max_retry > 0)
			setTimeout(()=>update(max_retry-1), 100)
	}
	update();
})();
