...
(function () {
    ...
    function getNextDayOfTheWeek(
        ...
        fromDate.setDate(
            fromDate.getDate() +
                ((dayOfWeek + 7 - fromDate.getDay() - !!excludeToday) % 7),
        );
        return fromDate;
    }
    function display() {
